// Taken from: https://github.com/kbuzsaki/bingosync/blob/master/bingosync-app/generators/generator_bases/synerGen.js
// Tweaked slightly to not modify the Math object which my browser didn't seem to like
...
bingoGeneratorSynerGen = function(bingoList, opts) {
    ...
    function magicSquare() {
        ...
        var randTable1 = table1[Math.floor(6 * RandomGen.random())];
        var randTable2 = table2[Math.floor(24 * RandomGen.random())];
        A = randTable1[0];
        B = randTable1[1];
        C = randTable1[2];
        D = randTable1[3];
        ...
        var ro = Math.floor(4 * RandomGen.random());
        var rf = Math.floor(2 * RandomGen.random());
        var tH = Math.floor(5 * RandomGen.random());
        var tV = Math.floor(5 * RandomGen.random());
    ...
    for (var i = 1; i <= 25; i++) {
        ...
        var index = Math.floor(RandomGen.random() * choosable.length);
