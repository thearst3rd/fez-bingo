// Taken from: https://github.com/kbuzsaki/bingosync/blob/master/bingosync-app/generators/generator_bases/srl_generator_v5.js
...
bingoGeneratorSrlv5 = function(bingoList, opts) {
    ...
    if (true) {
        ...
        for (var i = 1; i <= 25; i++) {
            ...
            var RNG = Math.floor(bingoList[getDifficulty].length * RandomGen.random());
