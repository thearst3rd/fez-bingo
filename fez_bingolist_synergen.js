var bingoListSynerGen = {
	...
	// Goals
	"0_bits": {"Desc": "Finish the run with 0 bits collected", "Diff": 1, "Types": ["numbits"]},
	"1_bits": {"Desc": "Finish the run with 1 bits collected", "Diff": 1, "Types": ["numbits"]},
	"monocle_anti": {"Desc": "Village - Monocle room anti cube", "Diff": 1},
	"achievement_anti": {"Desc": "Achievement code anti cube", "Diff": 1},

	"2_bits": {"Desc": "Finish the run with 2 bits collected", "Diff": 2, "Types": ["numbits"]},
	"3_bits": {"Desc": "Finish the run with 3 bits collected", "Diff": 2, "Types": ["numbits"]},
	...
	"4_bits": {"Desc": "Finish the run with 4 bits collected", "Diff": 3, "Types": ["numbits"]},
	"5_bits": {"Desc": "Finish the run with 5 bits collected", "Diff": 3, "Types": ["numbits"]},

	"6_bits": {"Desc": "Finish the run with 6 bits collected", "Diff": 4, "Types": ["numbits"]},
	"7_bits": {"Desc": "Finish the run with 7 bits collected", "Diff": 4, "Types": ["numbits"]},
	...
	"3_obelisks": {"Desc": "Collect 3 obelisk anti cubes", "Diff": 7, "Types": ["numobelisks"]},
	"2_tuning_forks": {"Desc": "Collect 2 tuning fork anti cubes", "Diff": 7, "Types": ["numtuningforks"]},
	...
	"": {"Desc": "Enter the two-cube door without collecting any of the bits in the village climb", "Diff": 8},
	"glitch_anti": {"Desc": "Nature - Glitch room anti cube", "Diff": 8},

	"4_golden": {"Desc": "Collect 4 golden cubes", "Diff": 9, "Types": ["numgolden"]},
	"4_anti": {"Desc": "Collect all 4 obelisk anti cubes", "Diff": 9, "Types": ["numobelisks"]},
	"3_map": {"Desc": "Collect 3 maps", "Diff": 9, "Types": ["nummaps"]},
	...
	"8_anti": {"Desc": "Collect 8 anti cubes", "Diff": 10, "Types": ["numanti"]},
	...
	"3_keys": {"Desc": "Have 3 keys in your inventory at the same time", "Diff": 11, "Types": ["numkeys"]},
	...
	"12_cube": {"Desc": "Collect 12 total cubes", "Diff": 12, "Types": ["numcubes"]},
	...
	"8_golden": {"Desc": "Collect 8 golden cubes", "Diff": 13, "Types": ["numgolden"]},
	"3_heart": {"Desc": "Collect all 3 heart pieces", "Diff": 13},
	"4_map": {"Desc": "Collect 4 maps", "Diff": 13, "Types": ["nummaps"]},

	"tree_owl": {"Desc": "Talk to the tree owl", "Diff": 14},
	"3_hub": {"Desc": "Visit 3 hubs", "Diff": 14},
	...
	"12_anti": {"Desc": "Collect 12 anti cubes", "Diff": 15, "Types": ["numanti"]},
	...
	"16_cube": {"Desc": "Collect 16 total cubes", "Diff": 17, "Types": ["numcubes"]},
	"4_key": {"Desc": "Have 4 keys in your inventory at the same time", "Diff": 17, "Types": ["numkeys"]},

	"pivot_cube": {"Desc": "Industrial - Pivot golden cube (after windmill)", "Diff": 18},
	"4_hub": {"Desc": "Visit 4 hubs", "Diff": 18},
	"6_map": {"Desc": "Collect 6 maps", "Diff": 18, "Types": ["nummaps"]},
	...
	"12_golden": {"Desc": "Collect 12 golden cubes", "Diff": 20, "Types": ["numgolden"]},
	...
	"truly_balanced": {"Desc": "Finish the run with the same number of golden cubes and anti cubes (excluding bits)", "Diff": 20},

	"complete_industrial_hub": {"Desc": "Fully complete the Industrial hub (including all small sub rooms)", "Diff": 21},
	"20_cube": {"Desc": "Collect 20 total cubes", "Diff": 21, "Types": ["numcubes"]},

	"old_zu_bit": {"Desc": "Collect the bit at the top of Old Zu", "Diff": 22, "Types": ["completezu"]},
	"5_hub": {"Desc": "Visit all 5 hubs", "Diff": 22},
	...
	"4_tuning_forks": {"Desc": "Collect all 4 tuning fork anti cubes", "Diff": 24, "Types": ["numtuningforks"]},
	"no_antis": {"Desc": "Finish the run without collecting any anti cubes", "Diff": 24, "Types": ["numanti"]},
